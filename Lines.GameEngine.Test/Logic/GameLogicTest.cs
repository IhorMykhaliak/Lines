...
namespace Lines.GameEngine.Test.Logic
{
    ...
    public class GameLogicTest
    {
        ...
        public void TestSelectBubbleTwice()
        {
            ...
            field[0, 0].ContainedItem = BubbleSize.Big;
            field[0, 0].Color = BubbleColor.Red;
            field[0, 2].ContainedItem = BubbleSize.Big;
        ...
        public void TestMoveToEmptyCell()
        {
            ...
            Assert.AreEqual(gameLogic.SelectedCell, null);
            Assert.AreEqual(field[0, 0].ContainedItem, null);
            Assert.AreEqual(field[0, 5].ContainedItem, BubbleSize.Big);
        ...
        public void TestMoveToEmptyCell_PathLocked()
        {
            ...
            field[1, 0].ContainedItem = BubbleSize.Big;
            ...
            Assert.AreEqual(gameLogic.SelectedCell, field[0, 0]);
            Assert.AreEqual(field[0, 0].ContainedItem, BubbleSize.Big);
            Assert.AreEqual(field[0, 0].Color, BubbleColor.Red);
            Assert.AreEqual(field[0, 5].ContainedItem, null);
        }
        ...
        public void TestMoveToCellWithSmallBubble()
        {
            ...
            field[0, 0].ContainedItem = BubbleSize.Big;
            field[0, 0].Color = BubbleColor.Red;
            field[0, 5].ContainedItem = BubbleSize.Small;
            ...
            Assert.AreEqual(field[0, 5].ContainedItem, BubbleSize.Big);
            Assert.AreEqual(field[0, 5].Color, BubbleColor.Red);
            Assert.AreEqual(field[1, 8].ContainedItem, BubbleSize.Big);
        ...
        public void TestVerticalLineWithSmallBubble()
        {
            Field field = new Field(10, 10);
            GameLogic gameLogic = new GameLogic(field, new FakeRandomStrategy(), 3);
            gameLogic.Field[1, 1].ContainedItem = BubbleSize.Big;
            gameLogic.Field[1, 1].Color = BubbleColor.Red;
            gameLogic.Field[1, 2].ContainedItem = BubbleSize.Big;
            gameLogic.Field[1, 2].Color = BubbleColor.Red;
            gameLogic.Field[1, 3].ContainedItem = BubbleSize.Big;
            gameLogic.Field[1, 3].Color = BubbleColor.Red;
            gameLogic.Field[1, 8].ContainedItem = BubbleSize.Big;
            gameLogic.Field[1, 8].Color = BubbleColor.Red;
            gameLogic.Field[1, 4].ContainedItem = BubbleSize.Small;
            gameLogic.Field[1, 4].Color = BubbleColor.Blue;
            gameLogic.Field[1, 5].ContainedItem = BubbleSize.Big;
            gameLogic.Field[1, 5].Color = BubbleColor.Red;

            gameLogic.SelectCell(1, 8);
            gameLogic.SelectCell(1, 4);

            Assert.AreEqual(gameLogic.Field[1, 1].ContainedItem, null);
            Assert.AreEqual(gameLogic.Field[1, 2].ContainedItem, null);
            Assert.AreEqual(gameLogic.Field[1, 3].ContainedItem, null);
            Assert.AreEqual(gameLogic.Field[1, 4].ContainedItem, BubbleSize.Small);
            Assert.AreEqual(gameLogic.Field[1, 5].ContainedItem, null);
        }
        ...
        public void TestInGameDoubleLine()
        {
            ...
            //left diagonal line
            gameLogic.Field[0, 1].ContainedItem = BubbleSize.Big;
            gameLogic.Field[0, 1].Color = BubbleColor.Red;
            gameLogic.Field[2, 2].ContainedItem = BubbleSize.Big;
            gameLogic.Field[2, 2].Color = BubbleColor.Red;
            gameLogic.Field[3, 3].ContainedItem = BubbleSize.Big;
            gameLogic.Field[3, 3].Color = BubbleColor.Red;
            gameLogic.Field[4, 4].ContainedItem = BubbleSize.Big;
            gameLogic.Field[4, 4].Color = BubbleColor.Red;
            gameLogic.Field[5, 5].ContainedItem = BubbleSize.Big;
            gameLogic.Field[5, 5].Color = BubbleColor.Red;
            //gameLogic.+ vertical line
            gameLogic.Field[2, 1].ContainedItem = BubbleSize.Big;
            gameLogic.Field[2, 1].Color = BubbleColor.Red;
            gameLogic.Field[3, 1].ContainedItem = BubbleSize.Big;
            gameLogic.Field[3, 1].Color = BubbleColor.Red;
            gameLogic.Field[4, 1].ContainedItem = BubbleSize.Big;
            gameLogic.Field[4, 1].Color = BubbleColor.Red;
            gameLogic.Field[5, 1].ContainedItem = BubbleSize.Big;
            ...
            Assert.AreEqual(gameLogic.Field[1, 1].ContainedItem, null);
            Assert.AreEqual(gameLogic.Field[2, 2].ContainedItem, null);
            Assert.AreEqual(gameLogic.Field[3, 3].ContainedItem, null);
            Assert.AreEqual(gameLogic.Field[4, 4].ContainedItem, null);
            Assert.AreEqual(gameLogic.Field[5, 5].ContainedItem, null);
            Assert.AreEqual(gameLogic.Field[2, 1].ContainedItem, null);
            Assert.AreEqual(gameLogic.Field[3, 1].ContainedItem, null);
            Assert.AreEqual(gameLogic.Field[4, 1].ContainedItem, null);
            Assert.AreEqual(gameLogic.Field[5, 1].ContainedItem, null);
        }
